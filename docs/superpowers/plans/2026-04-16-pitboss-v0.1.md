# Pitboss v0.1 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the v0.1 headless Rust dispatcher for parallel Claude Code agents ("Pitboss"), per `docs/superpowers/specs/2026-04-16-pitboss-design.md`.
...
- [ ] **Spec coverage check**: Every section/requirement in `docs/superpowers/specs/2026-04-16-pitboss-design.md` can be pointed at a task number above.
